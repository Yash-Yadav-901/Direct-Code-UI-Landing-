    ...
    <section ref={sectionRef} className="bg-gradient-to-br from-gray-900 to-gray-950 text-white py-20 px-6 md:px-12 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center">
          ...
          <button className=" bg-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center cursor-pointer">
